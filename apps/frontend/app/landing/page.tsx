...
import {
  LandingTraces,
  TraceDivider,
} from "@/components/landing/landing-traces";
...
export default function LandingPage() {
  return (
    <main className="relative flex flex-1 flex-col overflow-hidden text-foreground">
      ...
      <section className="relative z-[2] mx-auto flex w-full max-w-6xl flex-col px-4 pb-8 pt-28 sm:px-6 sm:pb-10 sm:pt-36">
      ...
      <section className="relative z-[2] mx-auto flex w-full max-w-6xl flex-col px-6 pb-12 pt-12">
        <LandingHow />
      </section>
