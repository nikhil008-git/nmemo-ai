...
export function ConnectorsDemo({
  ...
  return (
    <div className="mx-auto flex h-full max-w-lg flex-col justify-center gap-5 px-1 py-6">
      <div className="flex items-end justify-between gap-3">
        <div>
          <h2 className="font-heading text-[1.5rem] font-semibold tracking-[-0.03em] leading-[1.15] sm:text-[1.75rem]">
            Sources
          </h2>
          <p className="mt-1 text-sm font-semibold text-neutral-500">
            <span className="text-foreground">{connectedCount}</span> live ·
      ...
      <div className="grid grid-cols-2 gap-2.5">
        {rows.map((row) => (
          ...
          >
            ...
            <span className="mt-2.5 block font-heading text-sm font-semibold tracking-[-0.02em]">
              {row.name}
            </span>
            <span
              className={cn(
