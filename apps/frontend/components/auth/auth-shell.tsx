...
export function AuthShell({ children }: { children: React.ReactNode }) {
  return (
    <main className="relative flex min-h-screen bg-background">
      ...
      <div className="relative hidden min-h-screen w-1/2 overflow-hidden border-l border-border lg:block">
        <WallpaperPlate>
          <div className="pointer-events-none absolute left-[12%] top-[17%] h-[89%] w-[132%] select-none overflow-hidden rounded-[18px] border border-ink/10 bg-surface shadow-[0_28px_80px_-30px_rgba(0,0,0,0.7)]">
            <div className="product-shell flex h-full w-full bg-surface text-foreground">
              <WorkspaceSidebar
